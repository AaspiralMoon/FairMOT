...
# # Multi-Res
# exp_id = 'half-yolo_coco_multires_finetune_weighted_model_30_2_to_30'           # modify here
...
# model_root = '/nfs/u40/xur86/projects/DeepScale/FairMOT/exp/mot/mot17_half_half-yolo_coco_multires_finetune_weighted_model_30'  # modify here
...
# Single-Res
exp_id = 'half-yolo_coco_multires_finetune_weighted_model_43_2_to_30'           # modify here
result_root = '/nfs/u40/xur86/projects/DeepScale/datasets/MOT17/images/results'
exp_path = osp.join(result_root, exp_id)
xlsx_path = osp.join(exp_path, 'summary_{}.xlsx'.format(exp_id))
model_root = '/nfs/u40/xur86/projects/DeepScale/FairMOT/exp/mot/mot17_half_half-yolo_coco_multires_finetune_weighted_model_43'  # modify here
