...
# exp_id = 'quarter-dla34_coco_multires_finetune_weighted_classifier_model_389_lr_2_to_30'           # modify here
...
# model_root = '/nfs/u40/xur86/projects/DeepScale/FairMOT/exp/mot/mot17_half_quarter-dla34_coco_multires_finetune_weighted_classifier_model_389_lr'  # modify here
...
exp_id = 'multiknob_res_and_model_full_crowdhuman_multires_freeze_0.33_100_10_to_100'           # modify here
result_root = '/nfs/u40/xur86/projects/DeepScale/datasets/MOT17/images/results'
exp_path = osp.join(result_root, exp_id)
xlsx_path = osp.join(exp_path, 'summary_{}.xlsx'.format(exp_id))
model_root = '/nfs/u40/xur86/projects/DeepScale/FairMOT/exp/mot_multiknob/multiknob_res_and_model_full_crowdhuman_multires_freeze_0.33_100'  # modify here
