...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model', default='',
                             help='path to pretrained model')
    self.parser.add_argument('--load_full_model', default='',          # load full, half and quarter models in JDETracker, default path ../models/quarter-dla_34.pth
                             help='path to full model')
    self.parser.add_argument('--load_half_model', default='',          
    ...
    self.parser.add_argument('--interval', type=int, default=1, help='tune frame rate during tracking')
    self.parser.add_argument('--switch_period', type=int, default=100, help='trigger every K frames')
    self.parser.add_argument('--segment', type=int, default=30, help='in which the optimal frame rate is obtained')
