...
class JDETracker(object):
    def __init__(self, opt, frame_rate=30):
        ...
        heads_for_full_half_quarter = {'hm': opt.num_classes,                    # changes start here
    ...
    def update(self, im_blob, img0=None, img0_width=None, img0_height=None):
        self.frame_id += 1
        activated_starcks = []
        refind_stracks = []
        lost_stracks = []
        ...
        if img0 is None and img0_width is not None and img0_height is not None:
            width = img0_width
            height = img0_height
        else:
            width = img0.shape[1]
