...
avg_fps_dict = {}                  # store the avg_fps for 3 times exps

# for idx in imgsz_idx:
#     for m in model_list:
#         for t in range(1, 11):              # run 3 times to take the average
#             cmd_str = 'python track_half.py --task mot --exp_id profiling_{}_{} --load_model ../exp/mot_multiknob/gen_datasets_multiknob_full_crowdhuman/{}.pth --arch {} --imgsize_index {}'.format(imgsz_list[idx][0], m[:m.find('-')], m, m, idx)
#             os.system(cmd_str)
