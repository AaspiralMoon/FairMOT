...
#     for m in model_list:
#         for t in range(1, 4):              # run 3 times to take the average
#             if m == 'full-dla_34':
#                 cmd_str = 'python track_half.py --task mot_multiknob --exp_id profiling_{}_{} --load_model ../models/{}.pth --arch {} --imgsize_index {} --is_profiling True'.format(imgsz_list[idx][0], m[:m.find('-')], 'full-dla_34-multiknob', m, idx)
#             else:
