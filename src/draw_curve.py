...
DC_fps = np.array([33.5, 33.4, 31.4, 30.0, 27.0, 24.2, 20.4, 26.4, 18.1, 17.7, 17.1])               # FPS
DC_mota = np.array([59.2, 60.5, 61.6, 63.5, 65.9, 68.6, 69.9, 64.7, 70.1, 70.6, 70.9])          # MOTA
