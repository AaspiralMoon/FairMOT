...
# python train.py --task mot --exp_id mot17_half_full-dla34_coco_crowdhuman --load_model ../models/crowdhuman_dla34.pth --data_cfg ../src/lib/cfg/mot17_half.json --gpus 0,1 --batch_size 16
