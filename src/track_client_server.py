...
args = '--exp_id test_C2_client_server_arch2 \
        --task mot_multiknob \
...
client_str = 'CUDA_VISIBLE_DEVICES=3 python track_client_arch2.py {}'.format(args)
server_str = 'CUDA_VISIBLE_DEVICES=3 python track_server_arch2.py {}'.format(args)
